          ...
          <span key={index} className="flex items-center gap-1">
            ...
            {isLast ? (
              ...
              <button
                ...
                className={`bg-transparent border-none cursor-pointer p-0 text-magenta font-normal underline underline-offset-2 text-sm hover:opacity-70 transition-opacity ${
