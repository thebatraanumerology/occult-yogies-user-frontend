...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex h-dvh font-outfit w-full">
      ...
      <section className="bg-bg-secondary w-[45%] h-full flex items-center justify-center px-[10%]">
    ...
    // <div className="flex h-dvh font-outfit w-full">
    //   <section className="relative w-[50%] h-full flex items-center justify-center overflow-hidden ">
    //     <img
    //       src={loginBg}
    //       alt="Login Background"
    //       className="absolute inset-0 h-full w-full object-fill "
    ...
    //   <section className="bg-bg-secondary w-[50%] h-full flex items-center justify-center px-[10%] ">
    //     <article className="w-full text-white text-center max-w-md pr-12">
    //       <form
    //         onSubmit={handleSubmit(onSubmit)}
    //         className="flex flex-col gap-4"
